...
"""
chat_model = genai.GenerativeModel('gemini-1.5-flash-002',generation_config=generation_config,system_instruction=system_prompt)
...
def get_context(query, session_state):
    ...
    print("selected parent_ids : ",parent_ids)
...
def get_prompt(query, history=[], model="gemini", session_state=None):
    ...
    .
    """
    print(query +" Number of chars in the prompt : ",len(prompt))
